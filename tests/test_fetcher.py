...
ITER_ADT_SHAPE = [((25, 3595), (571, 3595)), ((25, 3595), (172, 3595))]
...
class TestLoader(unittest.TestCase):
    ...
    def test_iter_from_ADT(self):
        ...
        for (trigger, trigger_bg), (trigger_shape, trigger_bg_shape) in zip(
            adt_iter, ITER_ADT_SHAPE
        ):
